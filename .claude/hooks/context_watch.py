...
# Остаток < 30 / 20 / 10% = занято > 70 / 80 / 90%.
LEVELS = [(10, "handoff"), (20, "checkpoint"), (30, "caution")]
RANK = {"normal": 0, "caution": 1, "checkpoint": 2, "handoff": 3}

ACTIONS = {
    "caution": "Не начинай большой новый этап без контрольной точки.",
    "checkpoint": ("Сделай контрольную точку: /compact, если задача та же, "
                   "или /end для перехода в новый чат."),
